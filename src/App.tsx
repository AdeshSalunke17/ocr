...
function App() {
  ...
  return (
    <div className="App relative">
      <div className="main-background min-h-screen bg-linear-to-r from-[#ff80b5] to-[#9089fc] blur-2xl opacity-50"></div>
      <div className="absolute top-0 left-0 w-full h-screen">
        <div className="wrapper w-full h-screen top-0">
          {isPending && (
            <div className="w-full h-screen flex items-center justify-center bg-black z-50 absolute top-0">
              <Loader />
            </div>
          )}
